...
class UnitOfWork:
    ...
    def insert_new(self):
        ...
        for obj in self.new_objects:
            ...
            self.MapperRegistry.get_mapper(obj, self.connection).insert(obj)

    def update_dirty(self):
        for obj in self.dirty_objects:
            self.MapperRegistry.get_mapper(obj, self.connection).update(obj)

    def delete_removed(self):
        for obj in self.removed_objects:
            self.MapperRegistry.get_mapper(obj, self.connection).delete(obj)
